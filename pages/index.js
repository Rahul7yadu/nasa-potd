  ...
  return (
    <>
      <Head>
        ...
        <meta
          name='description'
          content='This web app shows nasa images using nasa free APIs- Integrated by Rahul Yadu; A full stack developer with nextjs framework hosted in vercel.'
        />
...
const Nasa = (props) => {
  ...
  return (
    <div className={`flex-col flex ${!isHd && 'lg:flex-row'} p-2`}>
      <div className={`flex justify-evenly ${!isHd && 'lg:hidden'} h-auto`}>
        <input
          ref={dateRef}
          type='date'
        ...
        <button
          ...
          className={`border-black border-2 p-2  bg-gray-400 text-gray-900 w-64 text-xs basis-1/12 mr-2 ml-8 `}
        >
          Search
        </button>
        <button
